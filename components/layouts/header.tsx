    ...
    const [notifications, setNotifications] = useState([
        {
            ...
            message: '<strong class="text-sm mr-1">Ersin Bahar</strong>invite you to <strong>UX Designing</strong>',
            time: '45 min ago',
        },
        {
            id: 2,
            profile: 'profile-34.jpeg',
            message: '<strong class="text-sm mr-1">Onur Görgün</strong>mentioned you to at<strong>side bar module</strong>',
            time: '9h Ago',
        },
        {
            id: 3,
            profile: 'profile-16.jpeg',
            message: '<strong class="text-sm mr-1">Team Paralyzed is</strong>on the move',
            time: '9h Ago',
        },
    ]);
                ...
                <ul className="horizontal-menu hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black dark:border-[#191e3a] dark:bg-black dark:text-white-dark lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse">
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            {/* <li>
                                <Link href="/analytics">{t('sales')}</Link>
                            </li>
                            <li>
